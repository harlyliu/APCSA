...
public class HanoiTower {
	 ...
	 *HERERERERERERRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR
	 *	to be completed by student ...
	 */
	 public void recursiveSolve(int from, int to, int helper, int amt){
		if (amt == 0)return;
		recursiveSolve(from, helper, to, amt-1);
		moveDisk(from, to);
		printTowers();
		recursiveSolve(helper, to, from, amt - 1);
	 }
